...
| 02/23/26   | Revised GUI buttons to not navigate<br>Added new packages to `requirements.txt` (`Jinja2` for HTML)<br>Updated file structure to include new `index.html` containing GUI framework |
